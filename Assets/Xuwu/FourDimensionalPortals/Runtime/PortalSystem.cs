...
namespace Xuwu.FourDimensionalPortals
{
    ...
    public sealed partial class PortalSystem : MonoBehaviour
    {
        ...
        public Material _writeStencilMaterial;
        public Material _stencilViewMaterial;
...
#pragma warning restore 0618
        ...
        public Shader WriteStencilShaderTest;
        public void Validate()
        {
            ...
            {
                _writeStencilMaterial.shader = WriteStencilShaderTest;
            }
            ...
            else
            {
                try
                {
                    _writeStencilMaterial = new Material(WriteStencilShaderTest) { hideFlags = HideFlags.HideAndDontSave };
                }
                catch (Exception e)
                {
            ...
            {
                _stencilViewMaterial.shader = ViewShaderTest; 
            }
               
            else
            {
                _stencilViewMaterial = new Material(ViewShaderTest) { hideFlags = HideFlags.HideAndDontSave }; 
            }
