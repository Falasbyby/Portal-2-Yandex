...
namespace CrazyGames
{
    public class GameModule : MonoBehaviour
    {
        ...
        public string GetInviteLinkParameter(string paramName)
        {
            ...
            {
                Debug.LogWarning("Cannot parse url in Unity editor, try running it in a browser");
                return "";
            }
        ...
        public bool IsInstantMultiplayer()
        {
            return _crazySDK.WrapSDKFunc(
                ...
                {
#if UNITY_WEBGL
                    return IsInstantMultiplayerSDK();
#else
            return false;
#endif
                },
                () =>
                {
                    _crazySDK.DebugLog("IsInstantMultiplayer check in editor");
                    return false;
                }
            );
        }
        ...
        {
            _crazySDK.DebugLog("Loading start called");
            _crazySDK.WrapSDKAction(LoadingStartSDK, () => { });
        }

        public void LoadingStop()
        {
            _crazySDK.DebugLog("Loading stop called");
            _crazySDK.WrapSDKAction(LoadingStopSDK, () => { });
        }

#if UNITY_WEBGL
        
        [DllImport("__Internal")]
        private static extern bool IsInstantMultiplayerSDK();
        ...
        [DllImport("__Internal")]
        private static extern void LoadingStartSDK();

        [DllImport("__Internal")]
        private static extern void LoadingStopSDK();
        ...
        private void LoadingStartSDK() { }

        private void LoadingStopSDK() { }
#endif
    }
}