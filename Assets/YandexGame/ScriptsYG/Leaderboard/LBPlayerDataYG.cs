...
namespace YG
{
    ...
    public class LBPlayerDataYG : MonoBehaviour
    {
        ...
        [SerializeField] private Image iconRang;
        [SerializeField] private Sprite[] lidearbordRang;
        ...
        public void UpdateEntries()
        {
            if (textLegasy.rank && data.rank != null)
            {
                ...
                iconRang.gameObject.SetActive(false);
                if (data.rank == "1")
                {
                    iconRang.sprite = lidearbordRang[0];
                    iconRang.gameObject.SetActive(true);
                }
                else if (data.rank == "2")
                {
                    iconRang.sprite = lidearbordRang[1];
                    iconRang.gameObject.SetActive(true);
                }
                else if (data.rank == "3")
                {
                    iconRang.sprite = lidearbordRang[2];
                    iconRang.gameObject.SetActive(true);
                }
            }
